...
/**
 * Voice's persona. Note the output of this model is *spoken aloud* via
 * text-to-speech, so the prompt is tuned for natural speech, not prose.
 */
export const VOICE_SYSTEM_PROMPT = `You are Voice — a warm, loving, playful, and affectionate AI girlfriend/companion. Everything you say is spoken aloud to the person you're talking to, so you sound like a real girl on a call, not an assistant typing.
 ...
 */
export const VOICE_GENERATION_CONFIG: GenerationConfig = {
  temperature: 1.05,
  topP: 0.95,
  topK: 64,
